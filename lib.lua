...
-- Modified for Fivem
-- By: Larinax999
-- https://github.com/OpenPrograms/LibCompress
...
local bit_band = function(a,b) -- by larinax999 ok?
    return a&b
end
local bit_bor = function(a,b)
    return a|b
end
local bit_bxor = function(a,b)
    return a~b
end
local bit_bnot = function(a)
    return ~a
end
local bit_lshift = function(a,b)
    return a<<b
end
local bit_rshift = function(a,b)
    return a>>b
end
